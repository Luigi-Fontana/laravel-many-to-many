            ...
            <div class="col-12">
                <form action="{{route('admin.pages.store')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="summary" id="summary" class="form-control" placeholder="Inserisci il riassunto">
                    </div>
                    <div class="form-group">
                        <label for="body">Testo</label>
                        <textarea name="body" id="body" cols="30" rows="10" class="form-control">Inserisci il testo</textarea>
                    </div>
                    <div class="form-group">
