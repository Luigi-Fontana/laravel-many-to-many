            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav justify-content-center">
                        <li class="nav-item">
                            <a class="nav-link btn btn-secondary m-3" href="{{route('admin.users.index')}}">Gestisci Admin</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn btn-secondary m-3" href="{{route('admin.info_users.index')}}">Gestisci Utenti</a>
                        </li>
                        <li class="nav-item">
